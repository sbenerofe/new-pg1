...
const NODE_ENVIRONMENT = process.env.APP_ENV || 'development';
...
function errorHandlerMiddleware(error, request, response, next) {
  ...
  console.debug('errorhandler in error middleware = ', error);
  // const validationErrorMsg = error.data[0].msg;
  // if (error.data[0].msg) logErrorMessage(error.data[0].msg);

  logErrorMessage('errmesg = ', errorMessage);
  ...
  console.log(' errorResponse.body = ', errorResponse.body);
  response.format({
    //
